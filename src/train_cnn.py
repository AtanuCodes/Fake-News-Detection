"""Train a 1D CNN fake-news classifier."""
...
from tensorflow.keras.layers import (
    Conv1D, Dense, Dropout, Embedding, GlobalMaxPooling1D, Input,
)
...
def main():
    ...
    evaluate(
        y_test, y_pred, args.out_dir, "cnn", y_score=y_score,
        classes=CLASS_NAMES,
    )

    model.save(args.out_dir / "cnn_model.keras")
    with open(args.out_dir / "cnn_tokenizer.pkl", "wb") as f:
        pickle.dump(tokenizer, f)
    (args.out_dir / "cnn_config.json").write_text(
